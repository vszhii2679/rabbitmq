 ...
 * @author sobann
 */
public class FanoutConsumerA extends ExchangeConnectionSupport {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 声明队列
        channel.queueDeclare("fanoutQueueA", false, false, false, null);
        // 队列绑定交换机
        channel.queueBind("fanoutQueueA", ExchangeConnectionSupport.FANOUT_EXCHANGE_NAME, "");
