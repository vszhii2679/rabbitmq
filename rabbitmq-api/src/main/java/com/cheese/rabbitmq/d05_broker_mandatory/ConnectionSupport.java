...
public abstract class ConnectionSupport {
    ...
    public static final String EXCHANGE_NAME = "mandatory_exchange";
    public static final String ROUTING_KEY = "mandatory_key";
    public static final String QUEUE_NAME = "mandatory_queue";
