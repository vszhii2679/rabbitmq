...
public abstract class ConnectionSupport {
    ...
    public static final String EXCHANGE_NAME = "ack_false_exchange";
    public static final String ROUTING_KEY = "ack_false_key";
    public static final String QUEUE_NAME = "ack_false_queue";
